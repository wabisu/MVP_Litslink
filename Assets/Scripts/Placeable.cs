...
public class Placeable : MonoBehaviour 
{
	...
	public bool ValidatePlacement(out Vector3 position, out Vector3 surfaceNormal)
	{
		...
		return ValidatePlacement (out position, out surfaceNormal, gameObject.transform, 0);
	}

	public bool ValidatePlacement(out Vector3 position, out Vector3 surfaceNormal, Transform transformToUse, float offset)
    {
		debug.text = "";
        ...
        {
			facePoints[i] = transformToUse.TransformVector(facePoints[i]) + transformToUse.position + transformToUse.forward * offset;
        }
